...
import { faCaretDown, faFilterCircleDollar, faFilterCircleXmark, faXmark } from '@fortawesome/free-solid-svg-icons';
...
function Products() {
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('box-content', 'wide')}>
                <h4 className={cx('title')}>Sản phẩm</h4>
                    <div className={cx('row')}>
                        <div className={cx('col', 'l-2-8', 'c-2-8','m-2-8')}>
                            <div className={cx('box', 'hide-on-mobile','hide-on-tablet')}>     
                            ...
                            <div className={cx('box-mobile')}>     
                                <div>
                                    <Button onClick={() => setShowMobile(true)} className={cx('btn-mobile')} leftIcon={<FontAwesomeIcon icon={faFilterCircleDollar}/>} >Lọc</Button>
                                </div>
                                <div className={cx('sort')}>
                                    {/*  // Using a wrapper <div> tag around the reference element solves this by creating a new parentNode context. */}
                                    <div>
                            ...
                            {/* PC */}
                            <ListProduct data={products} className={cx('l-3','m-4','c-6')} />
                            <Pagination totalCount={totalCount} limit={10} text='sản phẩm' />
                        </div>

                        {/* PC */}
                        <div className={cx('col', 'l-2-4','c-2-4','m-2-4','hide-on-mobile','hide-on-tablet')}>
                    ...
                    {/* Mobile */}
                    {showMobile && 
                        <div  className={cx('overlay-mobile')}>
                            <div onClick={() => setShowMobile(false)} className={cx('overlay')}></div>
                            <div className={cx('filter-mobile')}>
                                <div className={cx('mobile-header')}>
                                    <span onClick={() => setShowMobile(false)} className={cx('icon-mobile')}><FontAwesomeIcon  icon={faXmark} /></span>
                                    <span>Bộ lọc</span>
                                </div>
                            <div className={cx('box-check-mobile')}>
                                <div className={cx('box-check-item')}>
                                    <h4 className={cx('title-check')}>Đối tượng sử dụng</h4>
                                    <SearchItem dataCategory={used} type='category' render={render} />
                                </div>
