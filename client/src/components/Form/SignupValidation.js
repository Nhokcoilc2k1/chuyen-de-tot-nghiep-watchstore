...
export const promotionValidation = Yup.object({
    ...
    coupon_code: Yup.string().required('Vui lòng nhập mã khuyến mãi'),
    discount_value: Yup.string().required('Vui lòng nhập giá trị khuyến mãi'),
    min_order_value: Yup.string().required('Vui lòng nhập giá trị đơn hàng tối thiểu'),
